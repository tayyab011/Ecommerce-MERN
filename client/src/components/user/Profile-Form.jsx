          ...
          <div className="row mb-4">
            <div className="col-md-3 p-2">
              ...
              <input
                ...
                onChange={(e) => ProfileFormChange("cus_name", e.target.value)}
                type="text"
            ...
            <div className="col-md-3 p-2">
              ...
              <input
                ...
                onChange={(e) => ProfileFormChange("cus_phone", e.target.value)}
                type="text"
                className="form-control "
              />
            </div>
            <div className="col-md-3 p-2">
              ...
              <input
                ...
                onChange={(e) => ProfileFormChange(`cus_fax`, e.target.value)}
                type="text"
                className="form-control "
              />
            </div>
            ...
            <div className="col-md-3 p-2">
              ...
              <input
                ...
                onChange={(e) => ProfileFormChange(`cus_city`, e.target.value)}
                type="text"
                className="form-control "
              />
            </div>
            <div className="col-md-3 p-2">
              ...
              <input
                ...
                onChange={(e) => ProfileFormChange(`cus_state`, e.target.value)}
                type="text"
                className="form-control "
              />
            </div>
            ...
            <div className="col-md-3 p-2">
              ...
              <input
                ...
                onChange={(e) => ProfileFormChange(`cus_add`, e.target.value)}
                type="text"
                className="form-control "
              />
            </div>
          ...
          <div className="row">
            <div className="col-md-3 p-2">
              ...
              <input
                ...
                onChange={(e) => ProfileFormChange(`ship_name`, e.target.value)}
                type="text"
                className="form-control "
              />
            </div>
            ...
            <div className="col-md-3 p-2">
              ...
              <input
                ...
                onChange={(e) => ProfileFormChange(`ship_city`, e.target.value)}
                type="text"
                className="form-control "
              />
            </div>
            ...
            <div className="col-md-3 p-2">
              ...
              <input
                ...
                onChange={(e) => ProfileFormChange(`ship_add`, e.target.value)}
                type="text"
                className="form-control "
              />
            </div>
